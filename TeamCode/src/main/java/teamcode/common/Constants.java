...
public class Constants {
    ...
    //Game Constants
    public static final double TOP_POSITION = 18000; // +5k
    public static final double MEDIUM_POSITION = 12500; //store these values as ticks, and just go with that, nothing fancy
