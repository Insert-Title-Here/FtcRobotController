...
//    }
//
//    public CurvePoint getFollowPointPath(CurvePoint start, CurvePoint target, Point robotLocation, double followRadius){
//        CurvePoint followMe = new CurvePoint(start);
//        ArrayList<Point> intersections = lineCircleIntersection(robotLocation, followRadius, start.toPoint(), target.toPoint());
//        for(int i = 0; i < intersections.size(); i++){
//            Debug.log(intersections.get(i));
//        }
...
//    }
//
//    public boolean robotIsNearPoint(Point current, double tolerance) {
//        return sqrt(pow(current.x - robot.getCurrentPosition().x, 2) + pow(current.y - robot.getCurrentPosition().y, 2)) <= tolerance;
//    }
//
//
...
//        if(robotIsNearPoint(allPoints.get(allPoints.size() - 1)) || !isActive) {
//            brake();
//            return;
//        }
...
//    }
//    public CurvePoint getFollowMe(){
//        return followMe;
//    }
//
//    public void followCurve(CurvePoint start, CurvePoint target, double followAngle){
//        currentRobotIndex = 1;
//        followMe = getFollowPointPath(start, target, robot.getCurrentPosition(), target.followDistance);
//        if(robotIsNearPoint(target)){
//            brake();
//            return;
//        }
//        distanceTolerance = target.followDistance;
//        goToPosition(followMe.x, followMe.y, followMe.moveSpeed, followAngle, followMe.turnSpeed);
//    }
//
...
//        } else{
//            absoluteAngle = atan2(deltaY, deltaX);
//        }
...
//        MovementVars.movementTurn = clip(relativeTurnAngle / toRadians(180), -1, 1) * turnPower;
