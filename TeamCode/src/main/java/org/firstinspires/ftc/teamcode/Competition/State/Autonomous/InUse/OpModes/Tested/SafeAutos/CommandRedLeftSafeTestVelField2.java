...
@Autonomous(name = "Red Left (Safe) Field 2")
public class CommandRedLeftSafeTestVelField2 extends LinearOpMode {
    MecDriveV2 drive;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        pipeline = new KevinGodPipelineAprilTag(telemetry, drive, KevinGodPipelineAprilTag.AutoSide.RED_LEFT, false);
