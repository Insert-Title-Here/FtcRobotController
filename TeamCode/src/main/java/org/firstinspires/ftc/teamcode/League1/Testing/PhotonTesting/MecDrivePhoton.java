...
public class MecDrivePhoton {
    ...
    public MecDrivePhoton(HardwareMap hardwareMap, Robot robot , boolean pidEnabled, Telemetry telemetry){
    ...
    public MecDrivePhoton(HardwareMap hardwareMap, boolean pidEnabled, Telemetry telemetry){
        fl = hardwareMap.get(DcMotorEx.class, "FrontLeftDrive");
        fr = hardwareMap.get(DcMotorEx.class, "FrontRightDrive");
        bl = hardwareMap.get(DcMotorEx.class, "BackLeftDrive");
        br = hardwareMap.get(DcMotorEx.class, "BackRightDrive");
    ...
    public MecDrivePhoton(HardwareMap hardwareMap, boolean pidEnabled, Telemetry telemetry, boolean usingImu){
        fl = hardwareMap.get(DcMotorEx.class, "FrontLeftDrive");
        fr = hardwareMap.get(DcMotorEx.class, "FrontRightDrive");
        bl = hardwareMap.get(DcMotorEx.class, "BackLeftDrive");
        br = hardwareMap.get(DcMotorEx.class, "BackRightDrive");
    ...
    public MecDrivePhoton(HardwareMap hardwareMap, boolean pidEnabled, Telemetry telemetry, ColorRangeSensor color){
        fl = hardwareMap.get(DcMotorEx.class, "FrontLeftDrive");
        fr = hardwareMap.get(DcMotorEx.class, "FrontRightDrive");
        bl = hardwareMap.get(DcMotorEx.class, "BackLeftDrive");
        br = hardwareMap.get(DcMotorEx.class, "BackRightDrive");
    ...
    public void tankRotatePID(double radians, double power, boolean slidesUp){
        ...
        while(Math.abs(radError) > 0.005 && (time.seconds() - actualStartTime) < 1){
            ...
            setPowerAuto(newPower, MecDrivePhoton.MovementType.ROTATE);
...
//        double currentFilterEstimate = 0;
    ...
    public double setPowerAuto(double power, MecDrivePhoton.MovementType movement) {
        if(movement == MecDrivePhoton.MovementType.STRAIGHT) {
            setPower(power, power, power, power);
        }else if(movement == MecDrivePhoton.MovementType.STRAFE){
            setPower(power, -power, -power, power);
        }else if(movement == MecDrivePhoton.MovementType.ROTATE){
            setPower(power, -power, power, -power);
        }else if(movement == MecDrivePhoton.MovementType.LDIAGONAL){
            setPower(0, power, power,0);
        }else if(movement == MecDrivePhoton.MovementType.RDIAGONAL){
            //setPower(0, power, power, 0);
            setPower(power, 0, 0, power);
        }else if(movement == MecDrivePhoton.MovementType.RDIAGONALLESS){
            //setPower(0, power, power, 0);
            setPower(power, power/1.35, power/1.35, power);
        }else if(movement == MecDrivePhoton.MovementType.LDIAGONALLESS){
            //setPower(0, power, power, 0);
