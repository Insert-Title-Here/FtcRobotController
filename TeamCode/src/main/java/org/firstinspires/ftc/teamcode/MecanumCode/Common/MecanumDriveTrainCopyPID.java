...
public class MecanumDriveTrainCopyPID {
    ...
    public static PIDCoefficients pidCoeffs = new PIDCoefficients(0.5, 0, 0);
    ...
    public void PID(double velocity, int tics) {
        ...
        while(isFar(tics) && currentOpMode.opModeIsActive()) {
            ...
            setVelocity(pidGains.p + pidGains.i + pidGains.d);
