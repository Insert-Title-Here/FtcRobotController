...
public class TestingAutoRR extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence stuff = drive.trajectorySequenceBuilder(new Pose2d())
                .splineTo(
                        new Vector2d(15, -0),
                        Math.toRadians(180),
        ...
        TrajectorySequence stuff2 = drive.trajectorySequenceBuilder(newestTrajectory.end())
                .splineToLinearHeading(
                        new Pose2d(-50, -25, Math.toRadians(260)), Math.toRadians(260),
                ...
                .lineToConstantHeading(new Vector2d(-32, 75),
        ...
        Trajectory across = drive.trajectoryBuilder(new Pose2d(0, 0, Math.toRadians(270)))
                .back(110,
                        SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/* + 25*/, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/* + 17*/)
                )
       ...
       /* CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new InstantCommand(() -> drive.followTrajectory(firstTrajectory)),
                        new InstantCommand(() -> drive.followTrajectory(newestTrajectory)),


                        new InstantCommand(() -> drive.turn(Math.toRadians(10))),
                        new InstantCommand(() -> wheelieServo.setPosition(Constants.wheelieMedium)),

                        new InstantCommand(() -> score.setLinkagePosition(Constants.linkageUpV2 + 0.1)),
                        //wheelieServo.setPosition(Constants.wheelieMedium);

                        new ParallelCommandGroup(
                                new InstantCommand(() -> score.newLiftPD(57500, 1, 0.95)),
                                new InstantCommand(() -> score.setLinkagePositionSpecial(Constants.linkageScoreV2, 45000))
                        ),

                        new WaitCommand(70),
                        new InstantCommand(() -> score.setGrabberPosition(0.3)),
                        new WaitCommand(100),

                        new ParallelCommandGroup(
                        new InstantCommand(() -> score.setLinkagePositionLogistic(0.26, 500)),
                        new InstantCommand(() -> score.newLiftPD(0, 0.75, 0.75)),
        ...
        //drive.followTrajectorySequence(stuff);
