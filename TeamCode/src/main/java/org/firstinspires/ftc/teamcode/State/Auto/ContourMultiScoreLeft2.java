...
import org.firstinspires.ftc.teamcode.State.MultiAuto.MultiBlueLeftHIGH2;
import org.firstinspires.ftc.teamcode.State.MultiAuto.MultiRedLeftHIGH2;
...
@Config
public class ContourMultiScoreLeft2 extends OpenCvPipeline {
    ...
    */
    ...
    public ContourMultiScoreLeft2(Telemetry telemetry) {
    ...
    public Mat processFrame(Mat input) {
        ...
        if (MultiBlueLeftHIGH2.getNormalization() == Constants.Pipeline.PARK || MultiRedLeftHIGH2.getNormalization() == Constants.Pipeline.PARK) {
...
//        telemetry.addData("cyanColor", changed.get(0, 0,buff2));
            ...
            return original;
        } else if (MultiBlueLeftHIGH2.getNormalization() == Constants.Pipeline.POLE || MultiRedLeftHIGH2.getNormalization() == Constants.Pipeline.POLE) {
            // var inits / resets
...
//                perWidth = difference / loopSpecificPoints.length;
    ...
    */
            ...
            return generalMat;
        } else if (MultiBlueLeftHIGH2.getNormalization()  == Constants.Pipeline.CONE || MultiRedLeftHIGH2.getNormalization()  == Constants.Pipeline.CONE) {
            // var inits / resets
            knownWidth = 1.04; //inches
            contours = new ArrayList<>();
            // 43, 157, 166
