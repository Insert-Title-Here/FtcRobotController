...
@Autonomous(name = "Blue Left (Safe) Field 2")
public class CommandBlueLeftSafeTestVelField2 extends LinearOpMode {
    MecDriveV2 drive;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        pipeline = new KevinGodPipelineAprilTag(telemetry, drive, KevinGodPipelineAprilTag.AutoSide.BLUE_LEFT, false);
