...
@Autonomous(name = "Red Left (Safe) Field 1")
public class CommandRedLeftSafeTestVelField1 extends LinearOpMode {
    MecDriveV2 drive;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        pipeline = new KevinGodPipelineAprilTag(telemetry, drive, KevinGodPipelineAprilTag.AutoSide.RED_LEFT, true);
        ...
        CommandScheduler.getInstance().schedule(
                ...
                new InstantCommand(() -> cameraServo.setPosition(0.365)),
