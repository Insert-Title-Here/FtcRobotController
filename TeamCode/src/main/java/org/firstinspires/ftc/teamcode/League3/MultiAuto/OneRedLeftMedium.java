...
import org.firstinspires.ftc.teamcode.League3.Auto.DetectionAlgorithmLeft;
...
@Autonomous
public class OneRedLeftMedium extends LinearOpMode {
    MecanumDrive drive;
    ScoringSystem score;
    AtomicBoolean cont;
    Thread liftThread;
    DetectionAlgorithmLeft park;
    Constants constants;
    OpenCvWebcam webcam;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        park = new DetectionAlgorithmLeft(telemetry);
