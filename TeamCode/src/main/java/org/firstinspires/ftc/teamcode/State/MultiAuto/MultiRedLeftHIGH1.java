...
@Autonomous
@Config
public class MultiRedLeftHIGH1 extends LinearOpMode {
...
//            drive.turn90(Math.PI / 4 + Math.PI / 1.9);
            drive.absTurnPID(Math.PI / 2.2);
            drive.goToPosition(-0.6, 0.6, 0.6, -0.6, 50, "strafe left");
...
//            drive.turn90(Math.PI / 4 + Math.PI / 1.9);
             ...
             */
            drive.goToPosition(0.54, 0.5, 0.54, 0.5, 250, "forward a bit");
            safePark.set(true);
            grabbingCone = true;
            score.grabConeAuto();
            safePark.set(false);
...
//            }
            ...
            if (detect1.getParkPosition() == ContourMultiScoreLeft1.ParkingPosition.LEFT) {
                ...
                // go backwards
                drive.goToPosition(-0.7, -0.7, -0.7, -0.7, 370, "go backwards");
                sleep(100);
...
//            drive.goToPosition(0.52, 0.5, 0.52, 0.5, 36, "forward a bit");
    ...
    public void scoreConePreload(int fl, int fr, int bl, int br) {
        ...
        */
        ...
        //3700 - 3800
        drive.goToPosition(0.14, 0.138, 0.14, 0.138);
        // old: 7900     (9100 new)  (6800 new)  7400

        while (detect1.getBoundArea() <= 6400.0 || detect1.getBoundArea() >= 8400) { //7200
        ...
        if (opModeIsActive()) {
            ...
            if (grabbingCone && running) {
                ...
                if (detect1.getParkPosition() == ContourMultiScoreLeft1.ParkingPosition.LEFT) {
                    ...
                    drive.goToPosition(-0.6, 0.6, 0.6, -0.6, 501, "strafe left");
                    // go forward
                    drive.goToPosition(0.5, 0.5, 0.5, 0.5, 30, "strafe left");
