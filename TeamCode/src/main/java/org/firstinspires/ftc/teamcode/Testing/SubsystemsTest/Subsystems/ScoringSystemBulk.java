...
public class ScoringSystemBulk {
    ...
    public ScoringSystemBulk(HardwareMap hardwareMap, Data data) {
    ...
    public ScoringSystemBulk(HardwareMap hardwareMap, Telemetry telemetry, boolean up) {
    ...
    public ScoringSystemBulk(HardwareMap hardwareMap, Telemetry telemetry, ElapsedTime time, boolean up) {
        this.telemetry = telemetry;
        this.time = time;
